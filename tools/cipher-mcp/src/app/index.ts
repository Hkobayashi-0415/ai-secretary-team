...
program
	...
	.action(async (prompt: string[] = []) => {
		...
		if (
			...
			const errorMsg =
				'No API key or Ollama configuration found, please set at least one of OPENAI_API_KEY, ANTHROPIC_API_KEY, OPENROUTER_API_KEY, GEMINI_API_KEY, or OLLAMA_BASE_URL in your environment variables \nAvailable providers: OpenAI, Anthropic, OpenRouter, Gemini, Ollama, Qwen';
