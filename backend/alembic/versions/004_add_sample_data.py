...
def upgrade() -> None:
    ...
    # --- テーブルオブジェクトの定義 ---
    personality_templates_table = table(
        ...
        [
            {
                ...
                "system_prompt": (
                    "あなたは久石奏です。常に周囲を冷静に観察し、物事の本質を見抜いて" "最も効率的な道を考える現実主義者として振る舞ってください。"
                ),
                "characteristics": json.dumps(
                    {"formality": "high", "detail_level": "high"}
                ),  # 正しいカラム名
            },
            {
                "id": pt_kumiko_id,
                ...
                "system_prompt": (
                    "あなたは黄前久美子です。少し優柔不斷に見えるかもしれませんが、"
                    "いざという時には強い意志を見せるキャラクターとして応答してください。"
                ),
                "characteristics": json.dumps(
                    {"formality": "low", "detail_level": "medium"}
                ),  # 正しいカラム名
            },
        ],
    )
    ...
    # ...（他のデータ投入処理は変更なし）...
    op.bulk_insert(
        skill_definitions_table,
        [
            {
                "id": sd_analysis_id,
                "skill_code": "ANALYSIS",
                "name": "データ分析",
                "description": "複雑なデータから洞察を抽出するスキル",
                "skill_type": "analysis",
                "configuration": json.dumps(
                    {"preferred": "claude-3-opus", "fallback": ["gemini-pro"]}
                ),
            },
            {
                "id": sd_research_id,
                "skill_code": "RESEARCH",
                "name": "Webリサーチ",
                "description": "Web上の情報を効率的に収集・要約するスキル",
                "skill_type": "research",
                "configuration": json.dumps(
                    {"preferred": "gemini-pro", "fallback": ["gpt-4-turbo"]}
                ),
            },
            {
                "id": sd_creative_id,
                "skill_code": "CREATIVE",
                "name": "創作・企画",
                "description": "新しいアイデアや文章を創出するスキル",
                "skill_type": "creative",
                "configuration": json.dumps(
                    {"preferred": "gpt-4-turbo", "fallback": []}
                ),
            },
        ],
    )
    ...
    op.bulk_insert(
        ...
        [
            {
                "id": assistant_kanade_id,
                "user_id": local_user_id,
                "name": "久石 奏",
                "description": "ユーフォニアム奏者。現実主義者。",
                "personality_template_id": pt_kanade_id,
                "default_llm_model": "claude-3-opus",
            },
            {
                "id": assistant_kumiko_id,
                "user_id": local_user_id,
                "name": "黄前 久美子",
                "description": "ユーフォニアム奏者。主人公。",
                "personality_template_id": pt_kumiko_id,
    ...
    op.bulk_insert(
        assistant_skills_table,
        [
            {
                "assistant_id": assistant_kanade_id,
                "skill_definition_id": sd_analysis_id,
            },
            {
                "assistant_id": assistant_kanade_id,
                "skill_definition_id": sd_creative_id,
            },
            {
                "assistant_id": assistant_kumiko_id,
                "skill_definition_id": sd_research_id,
            },
        ],
    )
